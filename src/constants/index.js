...
const experiences = [
  ...
  },
  {
    ...
    points: [
      "Performing Data Analysis on the available data to provide useful insights.",
      "Collaborating with cross-functional teams including Data Analytics , product managers, and other interns.",
      "Developing Machine Learning Model to predict whether to provide loans to the customer or not .",
    ],
  },
  {
